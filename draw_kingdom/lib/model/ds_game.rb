...
class DSGame
  # Readers
  attr_reader :league, :game_date, :home_team, :away_team, :home_score, :away_score, :div, :season, :b365_draw_odds

  # Initialize
  def initialize(league, game_date, home_team, away_team, home_score, away_score, div, season, b365_draw_odds)
